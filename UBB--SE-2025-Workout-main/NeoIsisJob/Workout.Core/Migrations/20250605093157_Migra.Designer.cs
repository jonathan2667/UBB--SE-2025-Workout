...
namespace Workout.Core.Migrations
{
    ...
    [Migration("20250605093157_Migra")]
    partial class Migra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IngredientModelMealModel", b =>
                {
            ...
            modelBuilder.Entity("Workout.Core.Models.Group", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Workout.Core.Models.IngredientModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workout.Core.Models.MealModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IngredientModelMealModel", b =>
                {
                    b.HasOne("Workout.Core.Models.IngredientModel", null)
                        .WithMany()
                        .HasForeignKey("IngredientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Workout.Core.Models.MealModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ServerLibraryProject.DbRelationshipEntities.GroupUser", b =>
                {
                    b.HasOne("Workout.Core.Models.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Workout.Core.Models.UserModel", null)
                        .WithMany()
